                            ...
                            <tbody id="usersTableBody">
                                ...
                                <tr id="user-row-{{ $user->id }}">
                                    ...
                                    <td>
                                            ...
                                            <input class="form-check-input toggle-status" type="checkbox" id="status-{{ $user->id }}"
                                                   data-user-id="{{ $user->id }}"
                                                   {{ $user->is_active ? 'checked' : '' }}>
                                            <label class="form-check-label" for="status-{{ $user->id }}">
                                                <span class="badge {{ $user->is_active ? 'bg-success' : 'bg-danger' }}" id="status-badge-{{ $user->id }}">
