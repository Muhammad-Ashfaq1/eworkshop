...
@section('content')
    ...
    <div class="modal fade" id="js-vehicle-modal" tabindex="-1" aria-labelledby="js-vehicle-modal-label"
        aria-hidden="true">
...
@section('scripts')
    <script>
            ...
            $('#js-vehicle-form').validate({
                ...
                messages: {
                    vehicle_number: {
                        ...
                        minlength: "Vehicle number must be at least 2 characters"
                    },
                    category: {
        ...
        function populateForm(vehicle) {
            ...
            $('#js-category').val(vehicle.vehicle_category_id).trigger('change');;
            $('#js-condition').val(vehicle.condition);
            $('#js-town').val(vehicle.location_id).trigger('change');;
