...
<div class="row">
                ...
                <div class="live-preview">
                                    ...
                                    <div class="modal fade" id="editModalgrid" tabindex="-1" aria-labelledby="exampleModalgridLabel">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalgridLabel">Edit</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="" id="js-edit-location-form" method="POST">
                                                        @csrf
                                                        <div class="row g-3">
                                                            <div class="col-xxl-6">
                                                                <div>
                                                                    <label for="LocationName" class="form-label">Location Name</label>
                                                                    <input type="text" class="form-control" id="locationName" name="location_name" placeholder="Enter firstname">
                                                                </div>
                                                            </div>
                                                            <div class="col-xxl-6">
                                                                <div>
