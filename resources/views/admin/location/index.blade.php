...
<script>
    ...
    function setupFormValidation() {
        $('#js-location-form').validate({
            ...
            messages: {
                name: { required: "Please enter location name", minlength: "Location name must be at least 2 characters" },
                slug: { required: "Please enter slug", minlength: "Slug must be at least 2 characters" },
            ...
            submitHandler: function(form) {
                ...
                const method = $('#js-location-id').val() ? 'PUT' : 'POST';
